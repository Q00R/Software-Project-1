...
const AgentDashboard = () => {
    ...
    //     {
    //         id: "658877e17b86734fb53c2663",
    //         userId: "6588373b5fb675ade9be42b7",
    //         title: "Problem with the printer",
    ...
    //         rating: -1,
    //         priority: "High",
    //         creationDate: "2023-12-24T18:26:41.344Z",
    //         resolutionDate: "2023-12-25T01:13:12.266Z",
    //         __v: 0,
    //         assignedAgent: "6585ff65716ed6194e627d7c",
    //         response: "wtv"
    //     },
    //     {
    //         id: "658877e17b86734fb53c2663",
    ...
    //     },
    // ];
    // // Simulating a function to fetch resolved tickets (mocked)
    // const handleStatusResolved = async () => {
    //     return { data: mockResolvedTickets };
    // };
    //********** the one above is just for testing purposes **********//
        ...
        <main className='relative'>
            ...
            <section className='p-8'>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {
                        ticketCards.filter(ticket => {
                            if (statusChosen === "In Progress") {
                                return ticket.ticketStatus === "In progress"; // Assuming status key is "ticketStatus"
                            } else if (statusChosen === "Closed") {
                            ...
                            <div className="card bg-base-100 shadow-lg p-4">
                                <div className="card-body">
                                    ...
                                    <div className="flex space-x-2 mb-4">
                                        ...
                                        <span className="badge bg-violet-500">{ticket.ticketStatus}</span>
                                    </div>
