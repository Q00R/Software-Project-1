...
const AgentDashboard = () => {
    ...
    useEffect(() => {
        if (statusChosen === "All") {
            axios
                .get(`${agentURL}/tickets`, { withCredentials: true })
                .then((response) => {
                    setTicketCards(response.data);
                })
                .catch((error) => console.error("Could not fetch data", error));
    ...
    return (
        <main className='relative'>
            <section className="badge bg-violet-500">
                <button onClick={() => handleStatusInProgress()}>In Progress</button>
                <button onClick={() => handleStatusInProgress()}>Resolved</button>
            </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div className="card bg-base-100 shadow-lg p-4">
                        ...
                        <div className="flex space-x-2 mb-4">
                            ...
                            <span className="badge bg-violet-500">In progress</span>
                        </div>
