...
const AgentTicket = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("/viewActiveTickets:ticketId/:ticketStatus") // Replace with your actual backend URL and endpoint
      .then((response) => {
                    ...
                    <div className="modal-box p-6 bg-white rounded-lg shadow-md text-center">
                      ...
                      <div className="mt-4">
                        <button
                          ...
                          onClick={() =>
                            submitTicketResponse("658a1a991595fe60182050e1")
                          } // make this in the same loop beta3 el view tickets (dah lazem ykoon el ticket id)
                        >
                          Submit
                        </button>
                        <button
