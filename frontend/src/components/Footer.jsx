  ...
  return (
    <>
      <footer className="footer p-5 bg-base-200 text-base-content ">
        ...
        <nav>
          <header className="footer-title">Our Admins</header>
      ...
      <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
        ...
        <nav className="md:place-self-center md:justify-self-end">
          <div className="grid grid-flow-col gap-4">
            ...
            <a target="_blank" rel="noopener, noreferrer" href="https://www.npmjs.com/package/daisyui" className="link link-hover group">NPM
          ...
          className="inline-block w-4 fill-current opacity-0 group-hover:opacity-50">
            ...
            <div className="group relative">
              <a href="https://github.com/Q00R/Software-Project-1" target="_blank" rel="noopener noreferrer">
                <button>
                  <svg
